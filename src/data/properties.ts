...
export type PropertyGroup = {
  /** Human-facing category header shown in the facet sidebar. */
  label: string
  properties: Property[]
}
...
/** All properties, flat, in sidebar order. */
export const PROPERTIES: Property[] = PROPERTY_GROUPS.flatMap((g) => g.properties)
